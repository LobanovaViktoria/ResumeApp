...
final class SKillsCollectionCell: UICollectionViewCell {
    ...
    private var type: SkillCellType = .common
    ...
    override func layoutSubviews() {
        ...
        let rightConstant: CGFloat = self.type == .common ? leftPadding : 48
        ...
        NSLayoutConstraint.activate([
            ...
            skillLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: leftPadding),
    ...
    override func sizeThatFits(_ size: CGSize) -> CGSize {
        ...
        let labelWidth = skillLabel.sizeThatFits(CGSize(width: size.width - 48 - widthDelta, height: cellHeight)).width
